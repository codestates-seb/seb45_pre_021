  ...
  return (
    <ProfileContainer>
      ...
      <ProfileRight>
        ...
        <ProfileMiddleLayer>0 Saved Items</ProfileMiddleLayer>
        <ProfileBottomLayer>
          <svg
            aria-hidden="true"
...
const ProfileTopLayer = styled.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  button {
...
`;
const ProfileMiddleLayer = styled.div``;
const ProfileBottomLayer = styled.div`
  display: flex;
  align-items: center;

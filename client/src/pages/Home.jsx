...
const Home = () => {
  const stack = {
    ...
    java: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfSfoRVtnj_KTwOhHEncn6E20hLyVgjWuLDYUyLdImh-3qUQuPpAxNhtEc4MRDcD6KfUw&usqp=CAU',
    spring:
    ...
    springboot:
      'https://res.cloudinary.com/practicaldev/image/fetch/s--ejTngf1---/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_800/https://cdn-images-1.medium.com/max/2000/0%2AnPHVux9W1NhTpySv.png',
    amazonaws:
